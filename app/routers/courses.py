...
async def search_course(course_id: str, request: Request) -> dict[str, str]:
    """
...
async def delete_course_html(course_id: str, request: Request) -> dict[str, str]:
    """
    ...
    Returns:
        dict[str, str]: A dictionary containing the detail of the deletion operation.
    Raises:
        HTTPException: If the course record was not found and deleted.
    """
    delete_record = course_collection.find_one_and_delete({"cid": course_id})
    if not delete_record:
        raise HTTPException(status_code=400, detail="Course was not deleted")
...
async def create_course_html(
    ...
    """
    Create a new course using HTML form data.
    ...
    Returns:
    - HTML file containing user's information.
    """
...
async def get_course_update(course_id: str, request: Request) -> dict[str, str]:
    """
    Retrieve course update information.

    Args:
        course_id (str): The ID of the course to retrieve update information for.
        request (Request): The incoming request object.

    Returns:
        HTML file containting users information
...
async def update_course_html(
    ...
    """
    Update a course's information in the database and return the updated course HTML.

    Args:
        request (Request): The incoming request object.
        course_id (str): The ID of the course to be updated.
        cname (str): The updated name of the course.
        department (str): The updated department of the course.
        credit (str): The updated credit of the course.

    Returns:
        HTML file containing users updated information
